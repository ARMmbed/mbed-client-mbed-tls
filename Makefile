...
test: $(TESTDIRS)
	...
	gcovr --object-directory ./coverage --exclude '/usr' --exclude '.*mbed-client-mbed-tls_unit_tests*.' --exclude '${PWD}/stub/' --exclude '/yotta_modules/' --exclude '${PWD}/common/' --exclude '${PWD}/coverage/' -x -o ./lcov/gcovr.xml
