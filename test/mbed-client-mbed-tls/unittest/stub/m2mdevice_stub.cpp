...
M2MDevice *m2mdevice_stub::device;
...
{
    if(!m2mdevice_stub::device) {
        m2mdevice_stub::device = new M2MDevice("3");
    }
    return m2mdevice_stub::device;
}

void M2MDevice::delete_instance()
{
    delete m2mdevice_stub::device;
    m2mdevice_stub::device = 0;
}
